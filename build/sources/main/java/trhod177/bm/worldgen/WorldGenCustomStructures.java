...
public class WorldGenCustomStructures implements IWorldGenerator {
    ...
    private void runGenerator(WorldGenerator generator, World world, Random random, int chunkX, int chunkZ, int chance,
