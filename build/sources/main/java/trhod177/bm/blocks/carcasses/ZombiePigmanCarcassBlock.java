...
public class ZombiePigmanCarcassBlock extends CustomBlock {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	  
	public ZombiePigmanCarcassBlock(String name) {
...

	{
		...
		drops.add(new ItemStack(Items.GOLD_NUGGET, e));
		drops.add(new ItemStack(Items.GOLD_INGOT, a));
		drops.add(new ItemStack(Items.GOLDEN_SWORD, a));
	...
	@Override
	public ZombiePigmanCarcassBlock setCreativeTab(CreativeTabs tab) {
