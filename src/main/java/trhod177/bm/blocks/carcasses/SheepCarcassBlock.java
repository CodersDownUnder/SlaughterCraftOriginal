...
public class SheepCarcassBlock extends CustomBlock {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	  
	public SheepCarcassBlock(String name) {
	...
	drops.add(new ItemStack(ItemInit.muttonbelly, n));
	drops.add(new ItemStack(ItemInit.muttonleg, a));
	drops.add(new ItemStack(ItemInit.muttonshoulder, b));
	drops.add(new ItemStack(ItemInit.muttonrump, c));
	

	if(ConfigHandler.adddefaultdrops == true) {
		drops.add(new ItemStack(Items.MUTTON, a));
	}
