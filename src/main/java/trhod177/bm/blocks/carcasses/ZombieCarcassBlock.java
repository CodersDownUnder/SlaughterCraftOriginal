...
public class ZombieCarcassBlock extends CustomBlock {

	  
	  
	public ZombieCarcassBlock(String name) {
...

	{
		...
		drops.add(new ItemStack(Items.FEATHER, a));
	...
	@Override
	public ZombieCarcassBlock setCreativeTab(CreativeTabs tab) {
