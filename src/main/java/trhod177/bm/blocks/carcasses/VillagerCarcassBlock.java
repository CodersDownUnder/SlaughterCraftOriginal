...
public class VillagerCarcassBlock extends CustomBlock {

	  
	  
	public VillagerCarcassBlock(String name) {
	...
	@Override
	public VillagerCarcassBlock setCreativeTab(CreativeTabs tab) {
