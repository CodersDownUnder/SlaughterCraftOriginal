...
public class VindicatorCarcassBlock extends CustomBlock {
	
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	
    public VindicatorCarcassBlock(String name) {
    ...
    @Override
    public VindicatorCarcassBlock setCreativeTab(CreativeTabs tab) {
