...
public class DonkeyCarcassBlock extends CustomBlock{

	public DonkeyCarcassBlock(String name) {
...

	{
		...
		drops.add(new ItemStack(ItemInit.donkeymeat, e));
	...
	@Override
	public DonkeyCarcassBlock setCreativeTab(CreativeTabs tab) {
