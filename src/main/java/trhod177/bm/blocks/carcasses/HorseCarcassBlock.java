...
public class HorseCarcassBlock extends CustomBlock{

	public HorseCarcassBlock(String name) {
...

	{
		...
		drops.add(new ItemStack(ItemInit.horsemeat, e));
	...
	@Override
	public HorseCarcassBlock setCreativeTab(CreativeTabs tab) {
