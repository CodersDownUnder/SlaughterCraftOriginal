...
public class CreeperCarcassBlock extends CustomBlock {
	
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	
    public CreeperCarcassBlock(String name) {
    ...
    @Override
    public CreeperCarcassBlock setCreativeTab(CreativeTabs tab) {
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        drops.add(new ItemStack(Items.SKULL, e, 4));
        drops.add(new ItemStack(Items.GUNPOWDER, a));
