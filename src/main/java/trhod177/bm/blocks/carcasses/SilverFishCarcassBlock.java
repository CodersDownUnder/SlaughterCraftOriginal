...
public class SilverFishCarcassBlock extends CustomBlock {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	  
	public SilverFishCarcassBlock(String name) {
	...
	@Override
	public SilverFishCarcassBlock setCreativeTab(CreativeTabs tab) {
